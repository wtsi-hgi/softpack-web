      ...
      >
        <Grid item md={10} lg={8} mx="auto">
          ...
          <TypographyH2
            ...
            fontWeight="normal"
          >
            High performance React web app built with lots of powerful
            Material-UI components, giving you control over your environments!
          </TypographyH2>
          <Button
          ...
          <Grid container spacing={3} mt={5}>
            ...
            <Grid item md={6}>
              ...
              <Typography variant="h4">
                ...
                <Typography component="span" variant="subtitle2">
                  Features a modern technology stack and is
